...
Планируется: 
 ...
 6. Страница со всеми юзерами с отчетом сколько аккаунтов и персонажей создано
 7. Отдельная страница для просмотра персонажей с возможностью выдавать предметы из разрешенного списка
