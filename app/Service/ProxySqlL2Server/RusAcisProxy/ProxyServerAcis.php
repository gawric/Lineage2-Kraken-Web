...
use Exception;
   ...
   class ProxyServerAcis implements IProxy
   {
        ...
        public function getL2Item($modelItemsDb , $charactersDb , $char_name , $item_id){
           ...
           if(isset($owner_id) and isset($owner_id->obj_Id)){
             return $this->itemssql->getL2itemAcis($modelItemsDb , $char_name , $item_id, $owner_id->obj_Id);
           }
           else{
        ...
        public function getInfoAccountServer($login , $account_db_model , $server_name){
            return $this->accountssql->getInfoAccountServerRusAcis($login , $account_db_model , $server_name);
        }
