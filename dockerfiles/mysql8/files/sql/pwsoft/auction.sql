...
CREATE TABLE `auction` (
  ...
  `itemType` enum('ClanHall') NOT NULL,
  `itemId` smallint(5) unsigned NOT NULL default '0',
  `itemObjectId` int(10) unsigned NOT NULL default '0',
  `itemName` varchar(40) NOT NULL default '',
  `itemQuantity` tinyint(3) unsigned NOT NULL default '0',
  `startingBid` int(10) unsigned NOT NULL default '0',
